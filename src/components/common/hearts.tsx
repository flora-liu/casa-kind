...
function Heart1({ ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      {...props}
      width="82"
...
function Heart2({ ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      {...props}
      width="68"
...
function Heart3({ ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      {...props}
      width="46"
...
function Heart4({ ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      {...props}
      width="75"
