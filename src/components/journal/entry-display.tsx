  ...
  return (
    <div className={cn("px-5 md:px-0 w-full", className)}>
      <div className="py-2 md:py-4 w-full">
        <p
          className={cn(
            "whitespace-pre-line min-h-[12rem] md:min-h-[20rem] w-full resize-none rounded-md bg-background p-4 focus-within:outline-none text-sm md:text-base border border-input ring-offset-background",
            textareaStyles
          )}
        >
          {entry.content}
